...
//    : ListAdapter<PokemonModel,PokemonAdapter.PokemonViewHolder>(object:
//    DiffUtil.ItemCallback<PokemonModel>() {
//
...
class PokemonAdapter(private val listener : (PokemonModel)->Unit)
    : ListAdapter<PokemonModel,PokemonAdapter.HomeTransactionViewHolder>(object:
    DiffUtil.ItemCallback<PokemonModel>() {
    ...
    inner class HomeTransactionViewHolder(val binding : ItemPokemonBinding): RecyclerView.ViewHolder(binding.root){
        fun bind(pokemonModel: PokemonModel){
            val context = itemView.context
            with(binding){
                pokemonModel.also {
                    ...
                    when (it.type1) {
                        "BUG" -> chipType1.setBackgroundColor(R.color.bug.getColor(context))
                        "DARK" -> chipType1.setBackgroundColor(R.color.dark.getColor(context))
                        "DRAGON" -> chipType1.setBackgroundColor(R.color.dragon.getColor(context))
                        "ELECTRIC" -> chipType1.setBackgroundColor(R.color.electric.getColor(context))
                        "FAIRY" -> chipType1.setBackgroundColor(R.color.fairy.getColor(context))
                        "FIGHTING" -> chipType1.setBackgroundColor(R.color.fighting.getColor(context))
                        "FIRE" -> chipType1.setBackgroundColor(R.color.fire.getColor(context))
                        "FLYING" -> chipType1.setBackgroundColor(R.color.flying.getColor(context))
                        "GHOST" -> chipType1.setBackgroundColor(R.color.ghost.getColor(context))
                        "GRASS" -> chipType1.setBackgroundColor(R.color.grass.getColor(context))
                        "GROUND" -> chipType1.setBackgroundColor(R.color.ground.getColor(context))
                        "ICE" -> chipType1.setBackgroundColor(R.color.ice.getColor(context))
                        "NORMAL" -> chipType1.setBackgroundColor(R.color.normal.getColor(context))
                        "POISON" -> chipType1.setBackgroundColor(R.color.poison.getColor(context))
                        "PSYCHIC" -> chipType1.setBackgroundColor(R.color.psychic.getColor(context))
                        "ROCK" -> chipType1.setBackgroundColor(R.color.rock.getColor(context))
                        "STEEL" -> chipType1.setBackgroundColor(R.color.steel.getColor(context))
                        else -> chipType1.setBackgroundColor(R.color.water.getColor(context))
                    }

                    when (it.type2) {
                        "BUG" -> chipType2.setBackgroundColor(R.color.bug.getColor(context))
                        "DARK" -> chipType2.setBackgroundColor(R.color.dark.getColor(context))
                        "DRAGON" -> chipType2.setBackgroundColor(R.color.dragon.getColor(context))
                        "ELECTRIC" -> chipType2.setBackgroundColor(R.color.electric.getColor(context))
                        "FAIRY" -> chipType2.setBackgroundColor(R.color.fairy.getColor(context))
                        "FIGHTING" -> chipType2.setBackgroundColor(R.color.fighting.getColor(context))
                        "FIRE" -> chipType2.setBackgroundColor(R.color.fire.getColor(context))
                        "FLYING" -> chipType2.setBackgroundColor(R.color.flying.getColor(context))
                        "GHOST" -> chipType2.setBackgroundColor(R.color.ghost.getColor(context))
                        "GRASS" -> chipType2.setBackgroundColor(R.color.grass.getColor(context))
                        "GROUND" -> chipType2.setBackgroundColor(R.color.ground.getColor(context))
                        "ICE" -> chipType2.setBackgroundColor(R.color.ice.getColor(context))
                        "NORMAL" -> chipType2.setBackgroundColor(R.color.normal.getColor(context))
                        "POISON" -> chipType2.setBackgroundColor(R.color.poison.getColor(context))
                        "PSYCHIC" -> chipType2.setBackgroundColor(R.color.psychic.getColor(context))
                        "ROCK" -> chipType2.setBackgroundColor(R.color.rock.getColor(context))
                        "STEEL" -> chipType2.setBackgroundColor(R.color.steel.getColor(context))
                        else -> chipType2.setBackgroundColor(R.color.water.getColor(context))
                    }
                }
            }
            itemView.setOnClickListener {
                Log.d("adsfas", pokemonModel.toString())
                listener(pokemonModel)
            }
        }
    }
